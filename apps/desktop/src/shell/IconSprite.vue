...
// Спрайт иконок рейла. Отрисовывается один раз в оболочке, дальше на него
// ссылаются через <use href="#i-...">. Иконки взяты из design/screens.src.html:
// они часть дизайна и меняются вместе с ним.
</script>
...
<template>
  <svg aria-hidden="true" focusable="false" style="display: none">
    ...
    >
      ...
      <path d="M3.5 5.6v2a1.5 1.5 0 0 0 1.5 1.5h1.5" />
      <path d="M12.5 5.6v2a1.5 1.5 0 0 1-1.5 1.5H9.5" />
    </symbol>
    <symbol
      id="i-set"
      viewBox="0 0 16 16"
    ...
    <!-- Режим множественного выбора. Не голая галочка: та говорит «готово»
         и уже занята подтверждением — в строке совместимости она означает
         «этот воркфлоу здесь есть». Здесь речь о списке, в котором строки
         отмечают, поэтому строки в значке и нарисованы. -->
    <symbol
      id="i-checklist"
      viewBox="0 0 16 16"
      fill="none"
      ...
      stroke-linejoin="round"
    >
      <path d="M2 4.4 3.4 5.8 6.3 2.6" />
      <path d="M8.6 4.4h5.4" />
      <path d="M2 11.4 3.4 12.8 6.3 9.6" />
      <path d="M8.6 11.4h5.4" />
    </symbol>
    ...
    <!-- Отмена правки. Перечёркнутый круг, а не крестик: крестик рядом
         уже занят удалением строки, и две одинаковые кнопки в одном
         месте значили бы разное. -->
    <symbol
      id="i-ban"
      viewBox="0 0 16 16"
      fill="none"
