...
Связывает требования, истории, фазы реализации и разделы `PLAN.md`. Нужна для трёх вопросов: что уже покрыто требованиями, что запланировано в ближайшей фазе, и куда смотреть за техническим обоснованием.

Статус относится к **реализации**, не к написанию спецификации. Все требования ниже описаны; ни одно пока не реализовано.
...
| FR | Истории | Фаза | Раздел `PLAN.md` | Статус |
|---|---|---|---|---|
...
| FR | Истории | Фаза | Раздел `PLAN.md` | Статус |
|---|---|---|---|---|
| `FR-TAB-010` | `US-TAB-01` | 0.5 | Навигация и структура приложения | Не начато |
| `FR-TAB-020` | `US-TAB-02` | 0, 3 | Ключевые находки, факт 3 | Не начато |
| `FR-TAB-030` | `US-TAB-03` | 2 | Навигация и структура приложения | Не начато |
| `FR-TAB-040` | `US-TAB-03`, `US-TAB-04` | 2 | Навигация и структура приложения | Не начато |
| `FR-TAB-050` | `US-TAB-02`, `US-TAB-04` | 3 | webview.rs — встраивание | Не начато |
| `FR-TAB-060` | `US-TAB-02` | 3 | Грабли | Не начато |
| `FR-TAB-070` | `US-TAB-05` | 3 | Грабли | Не начато |
| `FR-TAB-080` | `US-TAB-06` | 3 | Экраны | Не начато |
| `FR-TAB-090` | `US-TAB-06` | 3 | Экраны | Не начато |
| `FR-TAB-100` | `US-TAB-01` | 0.5 | Навигация и структура приложения | Не начато |

### EP-SHARED — Общее хранилище моделей

| FR | Истории | Фаза | Раздел `PLAN.md` | Статус |
|---|---|---|---|---|
| `FR-SHARED-010` | `US-SHARED-01` | 2.5 | Общее хранилище моделей | Не начато |
| `FR-SHARED-020` | `US-SHARED-02` | 2.5 | Генерация YAML | Не начато |
| `FR-SHARED-030` | `US-SHARED-03`, `US-SHARED-07` | 2.5 | Два режима применения | Не начато |
| `FR-SHARED-040` | `US-SHARED-03` | 2.5 | Что выяснено из исходников | Не начато |
| `FR-SHARED-050` | `US-SHARED-04` | 2.5 | Два режима применения | Не начато |
| `FR-SHARED-060` | `US-SHARED-05` | 2.5 | Два режима применения | Не начато |
| `FR-SHARED-070` | `US-SHARED-06`, `US-SHARED-07` | 2.5 | Два режима применения | Не начато |
| `FR-SHARED-080` | `US-SHARED-02` | 2.5 | Общее хранилище моделей | Не начато |
| `FR-SHARED-090` | `US-SHARED-08` | 2.5 | Грабли | Не начато |
| `FR-SHARED-100` | `US-SHARED-03` | 2.5 | Грабли | Не начато |
| `FR-SHARED-110` | `US-SHARED-09` | 4 | Чеклист, Фаза 4 | Не начато |
| `FR-SHARED-120` | `US-SHARED-01` | 2.5 | Модель данных | Не начато |

### EP-WF — Библиотека воркфлоу

| FR | Истории | Фаза | Раздел `PLAN.md` | Статус |
|---|---|---|---|---|
| `FR-WF-010` | `US-WF-01` | 2.6 | Библиотека воркфлоу | Не начато |
| `FR-WF-020` | `US-WF-02` | 2.6 | Хранилище | Не начато |
| `FR-WF-030` | `US-WF-02` | 2.6 | Хранилище | Не начато |
| `FR-WF-040` | `US-WF-03` | 2.6 | Наполнение библиотеки | Не начато |
| `FR-WF-050` | `US-WF-04` | 2.6 | Добавление в инстанс | Не начато |
| `FR-WF-060` | `US-WF-04` | 2.6 | Добавление в инстанс | Не начато |
| `FR-WF-070` | `US-WF-05` | 2.6 | Проверка совместимости | Не начато |
| `FR-WF-080` | `US-WF-05` | 2.6 | Проверка совместимости | Не начато |
| `FR-WF-090` | `US-WF-06` | 2.6 | Хранилище | Не начато |
| `FR-WF-100` | `US-WF-07` | 2.6 | Добавление в инстанс | Не начато |
| `FR-WF-110` | `US-WF-06` | 2.6 | Грабли | Не начато |
...
| Фаза `PLAN.md` | Покрыта историями | Комментарий |
|---|---|---|
