...
| `FR-DATA-040` | `US-DATA-02` | 4б | Дисциплина хранения данных | Не начато |
| `FR-DATA-050` | `US-DATA-02` | 4б | Дисциплина хранения данных | Не начато |
| `FR-DATA-060` | `US-DATA-03` | 4б | Дисциплина хранения данных | Не начато |
| `FR-DATA-070` | `US-DATA-01` | 4а | Дисциплина хранения данных | Сделано |
| `FR-DATA-080` | `US-DATA-02` | 4б | Дисциплина хранения данных | Не начато |
| `FR-DATA-090` | `US-DATA-01` | 2.5, 2.6, 4а | Дисциплина хранения данных | Сделано |
| `FR-DATA-100` | `US-DATA-04` | 4б | Выпуск | Не начато |
| `FR-DATA-110` | `US-DATA-04` | 4б | Выпуск | Не начато |
| `FR-DATA-120` | `US-DATA-04` | 4б | Выпуск | Не начато |
...
| 4б — Упаковка и выпуск | Да | `US-DATA-02`, `US-DATA-03`, `US-DATA-04` |
